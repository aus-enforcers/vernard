...
namespace Vernard.Models
{
    internal class SettingsViewModel : BindableBase
    {
        ...
        {
            get => m_defaultTime;
            set => SetProperty(ref m_defaultTime, value);
        }
        ...
        {
            get => m_alwaysOnTop;
            set => SetProperty(ref m_alwaysOnTop, value);
        }
        ...
        {
            get => m_openAtLogin;
            set => SetProperty(ref m_openAtLogin, value);
        }

        private bool m_playWarnings;
        internal bool PlayWarnings
        {
            get => m_playWarnings;
            set => SetProperty(ref m_playWarnings, value);
        }

        private bool m_sendBeacon;
        internal bool SendBeacon
        {
            get => m_sendBeacon;
            set => SetProperty(ref m_sendBeacon, value);
        }

        private string m_beaconUrl;
        internal string BeaconUrl
        {
            get => m_beaconUrl;
            set => SetProperty(ref m_beaconUrl, value);
        }

        private int m_beaconInterval;
        internal int BeaconInterval
        {
            get => m_beaconInterval;
            set => SetProperty(ref m_beaconInterval, value);
        }

        private string m_beaconIdentifier;
        internal string BeaconIdentifier
        {
            get => m_beaconIdentifier;
            set => SetProperty(ref m_beaconIdentifier, value);
        }

        private string m_beaconToken;
        internal string BeaconToken
        {
            get => m_beaconToken;
            set => SetProperty(ref m_beaconToken, value);
        }
